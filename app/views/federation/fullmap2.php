...
function colorStates() {
								...
								success: function(data) {
										...
										$.each(data, function(index, field)
										{
												...
												$.ajax("/~" + eid + "/ct310/index.php/federation/status", {
														...
														function colorStates() {
															var color=["green","orange","teal", "purple"];
																...
																if(jQuery.type(status) === "object")
																{
																		...
																		if(status.status === "open")
																		{
																				if (idx>1){
																			if (idx===0){
																				$('#table-body').append($('<td style="background-color: green;">').append ($('<a />', { href: "/~" + "tsciano" +
																				"/ct310/index.php/federation/attraction/"+id, html:"EID: "+eid+ " ID: "+id+" Name: "+name +" State:"+ state+" Team Name: "
																				+ team})));
																				colorStates();
																			}
																			if (idx===1){
																				$('#table-body').append($('<td style="background-color: orange;">').append ($('<a />', { href: "/~" + "tsciano" +
																				"/ct310/index.php/federation/attraction/"+id, html:"EID: "+eid+ " ID: "+id+" Name: "+name +" State:"+ state+" Team Name: "
																				+ team})));
																				colorStates();
																			}
	...
	//                                     }
																...
																//this is if the status is represented as a string... this will turn that string into an object
																		...
																		if(idx>1){
																			if (idx==0){
																				$('#table-body').append($('<th style="background-color: green;">').append ($('<a />', { href: "/~" + "tsciano" +
																				"/ct310/index.php/federation/attraction/"+id, html:"EID: "+eid+ " ID: "+id+" Name: "+name +" State:"+ state+" Team Name: "
																				+ team})));
																				colorStates();
																			}
																			if (idx==1){
																				$('#table-body').append($('<th style="background-color: orange;">').append ($('<a />', { href: "/~" + "tsciano" +
																				"/ct310/index.php/federation/attraction/"+id, html:"EID: "+eid+ " ID: "+id+" Name: "+name +" State:"+ state+" Team Name: "
																				+ team})));
																				colorStates();
																			}
																		if (idx>=2){
																				// $('#table-body').append($('<tr style="background-color: green;">').text(status.status + " " + eid + " " + team));
																						// $('#table-body').append($('<tr style="background-color: green;">').text("id "+id+ " name "+name+ " state " + state));
																						$('#table-body').append($('<th style="background-color: teal;">').append ($('<a />', { href: "/~" + "tsciano" +
																						"/ct310/index.php/federation/attraction/"+id, html:"EID: "+eid+ " ID: "+id+" Name: "+name +" State:"+ state+" Team Name: "
																						+ team})));
																						colorStates();
																					}
